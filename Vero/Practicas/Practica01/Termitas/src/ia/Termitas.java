    ...
    class ModeloTermitas{
        ...
        */
        int direccionAleatoriaFrente(int direccion){
            ...
            int[][]opciones = new int[8][3];
            //basicamente todas las opciones por cada dirección.        
            opciones[0][0] = 0;
            opciones[0][1] = 1;
            opciones[0][2] = 7;
            ...
            return opciones[direccion][rnd.nextInt(3)];
        }
        ...
        */
        boolean hayAstilla(Termita t, int dir){
            ...
            int guardaX = t.posX;
            int guardaY = t.posY;
            moverTermita(t, dir); //movemos la termita
            boolean hayAstilla = mundo[t.posY][t.posX].estado; //esta ocupada?
            //regresamos a la posición anterior.
            t.posX = guardaX;
            t.posY = guardaY;       
            return hayAstilla;
        }
        ...
        /** Simula el comportamiento de soltar una astilla y mover a la hormiga en la direccion dada.
            @param t La tezrmita que suelta la astilla y se mueve en la cuadricula.
        ...
        */
        ...
        private void encuentraLugar(Termita t){
            boolean ocupado = true;
            while (ocupado){
                t.posX = rnd.nextInt(ancho);
                t.posY = rnd.nextInt(alto);
                if (mundo[t.posY][t.posX].estado){
                    encuentraLugar(t);
                }
                ocupado = false;
            }
